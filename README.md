...
*Counts and percentages only — no position sizes and no cash figures appear anywhere in this section, by construction. Regenerated by [`tools/scorecard.py`](tools/scorecard.py) from the private gate ledger; last built 2026-09-01.*

**251 decisions logged** across **72 names** over **92 days** · 13 published evaluations · 23 lines currently open
...
*107 blocked decisions are logged with a decision price, but none is yet 30 days old — too recent to have been right or wrong. This section fills itself in as they age.*

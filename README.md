...
*Counts and percentages only — no position sizes and no cash figures appear anywhere in this section, by construction. Regenerated by [`tools/scorecard.py`](tools/scorecard.py) from the private gate ledger; last built 2026-08-25.*

**148 decisions logged** across **64 names** over **85 days** · 7 published evaluations · 23 lines currently open
...
output/                   ← everything generated; never edit by hand
  ...
  data/                   analyst_ · facts_ · fundamentals_ · flow_ · xray_<date>

...
*Counts and percentages only — no position sizes and no cash figures appear anywhere in this section, by construction. Regenerated by [`tools/scorecard.py`](tools/scorecard.py) from the private gate ledger; last built 2026-08-24.*

**148 decisions logged** across **64 names** over **84 days** · 7 published evaluations · 23 lines currently open
...
*73 blocked decisions are logged with a decision price, but none is yet 30 days old — too recent to have been right or wrong. This section fills itself in as they age.*
...
| Card | Check | Blocked | |
|---|---|---:|---|
| 📈 Stock | **#6** Valuation headroom | 24 | `██████████████` |
| 📈 Stock | **#1** Composite score | 7 | `████░░░░░░░░░░` |
| 📈 Stock | **#5** Event window | 5 | `███░░░░░░░░░░░` |
| 📈 Stock | **#4** Volume character | 3 | `██░░░░░░░░░░░░` |
| 🧺 ETF | **#3** MA gatekeeper | 3 | `██░░░░░░░░░░░░` |
| 📈 Stock | **#7** Entry discipline | 2 | `█░░░░░░░░░░░░░` |
| 🧺 ETF | **#6** Premium / extension | 2 | `█░░░░░░░░░░░░░` |
...
When it finishes, read **[`output/latest.md`](output/latest.md)**.
...
| **Chart / flow platform** | MA direction, volume accumulation vs distribution, base structure, institutional flow |
...
| Document | Why |
|---|---|
| [`output/latest.md`](output/latest.md) | A real evaluation. Start here — everything else explains how this file gets made |
...
| [`docs/FLOW_FIRST_PROPOSAL.md`](docs/FLOW_FIRST_PROPOSAL.md) | Live proposal — read its banner first. Required reading before changing anything in the rotation path |
...
output/                   ← everything generated; never edit by hand
  ...
  latest.md               pointer → the newest evaluation
  radar/                  Heartbeat_Radar_<date>.md    + latest.md
  data/                   analyst/ · facts/ · fundamentals/ · xray/  (each with latest.md)
...
docs/                     ← operational user-guides
  ...
  FLOW_FIRST_PROPOSAL.md  Live proposal: flow leg replaces the inferred rotation read
  SMART_MONEY_BOARD.md    Its design — provider contract, significance floor, twin table
  FLOW_PARALLEL_RUN_<d>.md  Parallel-run log, one per run, until Phase 1 ships
...
agents/                   canonical agent + orchestration contracts
  ...
  → .claude/commands/     /atd-daily + /atd-publish wrappers · → .opencode/command/
  → invariant 8: --check  drift is caught by CI

engine/                   daily radar
tools/                    facts · fundamentals · xray · pnl · checks · append_gate_ledger · rerun

...
- **Nothing here is backtested.** These rules were derived from post-mortems of individual decisions, not from statistical validation. They may be wrong. The gate ledger exists precisely because their value is unproven — it is the mechanism for finding out, not evidence that the question is settled.
